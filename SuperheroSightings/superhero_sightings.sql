...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema superhero_sightings
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `superhero_sightings` ;

-- -----------------------------------------------------
-- Schema superhero_sightings
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `superhero_sightings` DEFAULT CHARACTER SET utf8 ;
USE `superhero_sightings` ;

-- -----------------------------------------------------
-- Table `superhero_sightings`.`locations`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `superhero_sightings`.`users` ;

CREATE TABLE IF NOT EXISTS `superhero_sightings`.`users` (
...
DROP TABLE IF EXISTS `superhero_sightings`.`authorities` ;
...
DROP TABLE IF EXISTS `superhero_sightings`.`locations` ;
...
CREATE TABLE IF NOT EXISTS `superhero_sightings`.`locations` (
  ...
  `latitude` DOUBLE(9,6) NOT NULL Default 0.0,
  `longitude` DOUBLE(9,6) NOT NULL default 0.0,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `superhero_sightings`.`organizations` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `superhero_sightings`.`superheros` ;

CREATE TABLE IF NOT EXISTS `superhero_sightings`.`superheros` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `superhero_sightings`.`super_organization_affiliation` ;

CREATE TABLE IF NOT EXISTS `superhero_sightings`.`super_organization_affiliation` (
  ...
  CONSTRAINT `fk_soa_organization`
    ...
    REFERENCES `superhero_sightings`.`organizations` (`organization_id`),
  CONSTRAINT `fk_soa_superhero`
    FOREIGN KEY (`super_id`)
    REFERENCES `superhero_sightings`.`superheros` (`super_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


DROP TABLE IF EXISTS `superhero_sightings`.`super_sightings` ;

CREATE TABLE IF NOT EXISTS `superhero_sightings`.`super_sightings` (
